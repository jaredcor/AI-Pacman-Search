...
""" % (prereq, q, q, prereq))
    ...
    if bonusPic and (self.points.totalCount() == 50):
      print("""
                     ...
                     YOU ARE DONE WITH PROJECT 1
              LONG LIVE PACMAN. YOU ARE NOT DONE WITH THE GAME THOUGH!
...
""")
    if bonusPic and (self.points.totalCount() == 52):
      print("""

                YOU ARE DONE WITH PROJECT 1 AND GOT YOUR EXTRA MARKS
              LONG LIVE PACMAN. YOU ARE NOT DONE WITH THE GAME THOUGH!
